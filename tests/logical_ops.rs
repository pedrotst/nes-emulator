...
fn rol_accumulator(){
    ...
    cpu.load_and_run_no_reset(vec![0x2a, 0x00]);
    assert_eq!(cpu.register_a, 0);
    assert_eq!(cpu.status & 0b0000_0011, 0b0000_0011);
}
...
fn rol_accumulator_rotate(){
    ...
    cpu.load_and_run_no_reset(vec![0x2a, 0x2a, 0x00]);
...
fn rol_accumulator_rotate2(){
    ...
    cpu.load_and_run_no_reset(vec![0x2a, 0x2a, 0x2a, 0x00]);
...
fn rol_zero_page(){
    ...
    cpu.load_and_run_no_reset(vec![0x26, 0x12, 0x00]);
    let data = cpu.mem_read(0x12);
    assert_eq!(data, 0);
    assert_eq!(cpu.status & 0b0000_0011, 0b0000_0011);
}
...
fn rol_zero_page_rotate(){
    ...
    cpu.load_and_run_no_reset(vec![0x26, 0x12, 0x26, 0x12, 0x00]);
    let data = cpu.mem_read(0x12);
...
fn rol_zero_page_rotate_2(){
    ...
    cpu.load_and_run_no_reset(vec![0x26, 0x12, 0x26, 0x12, 0x26, 0x12, 0x00]);
    let data = cpu.mem_read(0x12);
